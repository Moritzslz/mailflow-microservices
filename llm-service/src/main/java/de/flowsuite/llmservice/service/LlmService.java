...
public class LlmService {
    ...
    public Optional<CategorisationResponse> categoriseMessage(
        ...
        for (int attempt = 0; attempt < maxAttempts; attempt++) {
            ...
            if (categorisationResponse.isPresent()) {
                ...
                LOG.info(
                        "Successfully categorised message for user {}. Category: {}",
                        user.getId(),
                        category.getMessageCategory().getCategory());
    ...
    public Optional<String> generateReply(
        ...
        LOG.info(
                "Successfully generated reply message for user {}. Rating URL: {}",
                user.getId(),
                ratingUrl);
    ...
    private String fetchRagContext(
        ...
        LOG.info(
                "No relevant context found for user {} and message thread {}",
                userId,
                messageThread);
        return null;
    }
